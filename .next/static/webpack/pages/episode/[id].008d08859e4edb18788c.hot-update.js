  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (ShowState) {
      ...
      var res = ShowState._embedded.episodes.find(function (x) {
        console.log(x.id === Number(id), x.id, id);
        x.id === id;
      });
